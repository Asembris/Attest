...
| **Full pipeline**, prose in, 40 cases | accuracy **1.0**, macro-F1 **1.0**, **40/40** extractions exact with **0** extras and **0** duplicates, **39/40** model-authored explanations, **1** template fallback, **7** guard rejections, **$0.01570005**, pass@3 = 1.0 | [`full.json`](benchmark/results/full.json) · `just bench-full` |
