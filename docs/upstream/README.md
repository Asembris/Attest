...
maintainer response yet. **A fix for #168 is proposed at
[PR #182](https://github.com/acryldata/mcp-server-datahub/pull/182)**, opened 2026-08-04 —
open; not reviewed, not merged. **Draft 3 is deliberately NOT filed** and stays a draft — see
below.
...
| [2](issue-2-dataset-lastmodified.md) | Dataset `properties.lastModified` is never requested by any tool | Filed: [#168](https://github.com/acryldata/mcp-server-datahub/issues/168); fix proposed: [PR #182](https://github.com/acryldata/mcp-server-datahub/pull/182), open | **High.** Exactly the shape of upstream #118, which has a PR. |
